import { ViewChild, ElementRef, OnChanges, SimpleChanges, Input, EventEmitter, Output, Component } from "@angular/core";
...
@Component({
  ...
  styleUrls: ['./ion-date-slider.component.scss']
})
export class IonDateSliderComponent implements OnChanges {
  ...
  ngOnInit() {
      ...
      // this.inputElem = this._el.nativeElement.getElementsById('timelineSlider')[0];
      // this.initSlider();
  }
